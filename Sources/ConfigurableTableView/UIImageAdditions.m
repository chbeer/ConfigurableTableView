...
@implementation UIImage (CBCTVAddition)

///////////////////////////////////////////////////////////////////////////////////////////////////
// private

- (void)cbctvAddRoundedRectToPath:(CGContextRef)context rect:(CGRect)rect radius:(float)radius {
...
- (void)cbctvDrawInRect:(CGRect)rect contentMode:(UIViewContentMode)contentMode {
  ...
  if (self.size.width != rect.size.width || self.size.height != rect.size.height) {
    ...
    rect = [self cbctvConvertRect:rect withContentMode:contentMode];
  }
...
- (void)cbctvDrawInRect:(CGRect)rect radius:(CGFloat)radius {
  [self cbctvDrawInRect:rect radius:radius contentMode:UIViewContentModeScaleToFill];
}
...
- (void)cbctvDrawInRect:(CGRect)rect radius:(CGFloat)radius contentMode:(UIViewContentMode)contentMode {
  ...
  CGContextSaveGState(context);
  if (radius) {
    [self cbctvAddRoundedRectToPath:context rect:rect radius:radius];
    CGContextClip(context);
  }
  
  [self cbctvDrawInRect:rect contentMode:contentMode];
